          ...
          <div className="space-y-8">
            ...
            <div className="space-y-6 justify-center">
              <div className="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <a
                    href="mailto:prajowalk09@gmail.com"
                    className="text-muted-foreground hover:text-primary transition-colors"
                  >
                    prajowalk09@gmail.com
                  </a>
                </div>
              </div>
              <div className="flex items-start space-x-4">
            ...
            <div className="pt-8">
              ...
              <div className="flex space-x-4 justify-center">
                <a
                  href="https://www.linkedin.com/in/prajwol-karki-612b90368/"
                  target="_blank"
                >
                  <Linkedin />
                </a>
                <a href="https://x.com/prajwolk09" target="_blank">
                  <Twitter />
                </a>
                <a href="https://www.facebook.com/prazol.k01" target="_blank">
                  <Facebook />
                </a>
                <a
                  href="https://www.instagram.com/prajwol._.k/?__pwa=1"
                  target="_blank"
                >
                  <Instagram />
                </a>
